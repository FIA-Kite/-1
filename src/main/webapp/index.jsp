            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">FIA管理后台</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">FIA</div>
                    </li>
                    <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                     ...
                     <li>
                        <a class="J_menuItem" href="Operater/index">
                   ...
                   <li>
                        <a class="J_menuItem" href="Product/index">
                            <i class="fa fa-home"></i>
                    ...
                    <li>
                        <a class="J_menuItem" href="Type/type-list">
                            <i class="fa fa-home"></i>
                    ...
                    <!--  <li>
                        <a class="J_menuItem" href="Shopcar/index">
                            <i class="fa fa-home"></i>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                   ...
                   <!--  <a class="navbar-minimalize minimalize-styl-2 btn btn-info " href="#">
                    ...
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-info " href="#">
                    <i>欢迎登录：${sessionScope.operater.name}</i> </a>
